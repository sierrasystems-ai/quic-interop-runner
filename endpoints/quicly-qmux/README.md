...
Library patches on that branch:
...
2. Schedule connection-level `MAX_DATA` updates after QMux receives stream data (needed for quicly self-transfer under suite windows).
