...
// NextProto is the ALPN token for HTTP/0.9 over QUIC used by the classic interop suite.
const NextProto = "hq-interop"

// NextProtoQMux is the ALPN token for HTTP/0.9 over QMux draft-02.
const NextProtoQMux = "hq-qmux"
...
// Server is a HTTP/0.9 server listening for QUIC/QMux connections.
type Server struct {
...
// ServeQUICConn serves HTTP/0.9 on a single QUIC or QMux connection.
